...
public class GalenExample2_GeneralWebelementAttributesAdditional
{

	//	Testing additional general web element attributes
    ...
    public void homePageLayoutTest() throws IOException
    {
        ...
        LayoutReport objLayoutReport = 
        		Galen.checkLayout(driver, specFilePath, Arrays.asList("desktop_GeneralWebelementAttributesAdditional"));

        //Create a galen test info list
        List<GalenTestInfo> objGalentestsList	= new LinkedList<GalenTestInfo>();
        //Create a GalenTestInfo object
        GalenTestInfo objSingleGalenTest 		= GalenTestInfo.fromString("GeneralWebelementAttributesAdditional main title here");
        //Get layoutReport and assign to test object
        objSingleGalenTest.getReport().layout(objLayoutReport, "GeneralWebelementAttributesAdditional single test title here");
        ...
        htmlReportBuilder.build(objGalentestsList, "ReportFolder_GeneralWebelementAttributesAdditional");
        //If layoutReport has errors Assert Fail
        if (objLayoutReport.errors() > 0)
        {
        	System.out.println("Layout test failed for GeneralWebelementAttributesAdditional");
            Assert.fail();
        }
        System.out.println("Layout test PASSED for GeneralWebelementAttributesAdditional");
    }

    private WebDriver driver  = null;
    String specFilePath 			= "galen_spec_gspec/GeneralWebelementAttributesAdditional.gspec";
